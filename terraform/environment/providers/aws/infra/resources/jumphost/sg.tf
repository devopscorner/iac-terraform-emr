# ==========================================================================
#  Resources: Jumphost / sg.tf (Security Group Configuration)
# --------------------------------------------------------------------------
#  Description
# --------------------------------------------------------------------------
#    - SSH Port
...
resource "aws_security_group" "jumphost" {
  name        = "${var.jumphost_name}-${var.env[local.env]}-sg"
  description = "${var.jumphost_name}-${var.env[local.env]} security groups"
