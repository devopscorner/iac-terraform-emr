# ==========================================================================
#  Resources: Jumphost / jumphost.tf (Jumphost Configuration)
# --------------------------------------------------------------------------
#  Description
# --------------------------------------------------------------------------
#    - VPC References
...
locals {
  resources_tags = {
    Name          = "${var.jumphost_name}-${var.env[local.env]}",
...
# ------------------------------------
locals {
  domain      = "${var.jumphost_name}-${var.env[local.env]}.${var.dns_url[local.env]}"
