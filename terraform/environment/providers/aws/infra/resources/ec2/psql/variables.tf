...
variable "kms_key" {
  ...
  default = {
    lab     = "arn:aws:kms:ap-southeast-1:YOUR_AWS_KEY:key/CMK_KEY_HASH"
    staging = "arn:aws:kms:ap-southeast-1:YOUR_AWS_KEY:key/CMK_KEY_HASH"
    prod    = "arn:aws:kms:ap-southeast-1:YOUR_AWS_KEY:key/CMK_KEY_HASH"
  }
}
