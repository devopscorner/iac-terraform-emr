...
variable "cloud9_user_data_url" {
  type    = string
  default = "https://raw.githubusercontent.com/devopscorner/devopscorner-terraform-emr/main/terraform/environment/providers/aws/infra/resources/cloud9/userdata/user-data.sh"
}
