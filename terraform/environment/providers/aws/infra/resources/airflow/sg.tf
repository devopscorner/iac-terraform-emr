# ==========================================================================
#  Resources: Airflow / sg.tf (Security Group Configuration)
# --------------------------------------------------------------------------
#  Description
# --------------------------------------------------------------------------
#    - SSH Port
...
resource "aws_security_group" "airflow" {
  name        = "${var.airflow_name}-${var.env[local.env]}-sg"
  description = "${var.airflow_name}-${var.env[local.env]} security groups"
